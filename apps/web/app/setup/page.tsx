...
export default function SetupPage() {
 ...
 Historiador <span style={{ fontFamily: "var(--font-sans)", fontStyle: "normal", fontSize: 18, fontWeight: 500 }}>Doc</span>
 </div>

 <div className="max-w-[440px] text-[16px] leading-relaxed opacity-85 mb-auto">
 Toda equipe tem memória. O Historiador Doc transforma essa memória em páginas — conversando com você.
 </div>

 <h1
 className="mt-auto mb-0"
 style={{ fontFamily: "var(--font-display)", fontSize: 52, lineHeight: 1.05, fontWeight: 400, margin: 0 }}
 >
 ...
 style={{ background: i <= currentIndex ? "white" : "rgba(255,255,255,0.25)" }}
 />
 ))}
 </div>
 </aside>
 ...
 {probeResult && (
 <p className={`text-sm ${probeResult.success ? "text-teal-600" : "text-red-600"}`}>
